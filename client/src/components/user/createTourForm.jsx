...
class createTourForm extends FormInput {
  ...
  handleSubmitData(event) {
    ...
    if (
      this.state.dataTour.startFreeDate === null ||
  ...
  handleChange(event) {
    if (this.conditionValue.includes(event.target.name)) {
      if (event.target.value === "true")
        this.state.dataTour[event.target.name] = true;
...
*/
    this.dataForm = [
      [
        "textarea",
        ["Your Tour Name", "name", this.handleChange, true, "tourName"]
      ],
      ["textarea", ["Your Destination", "dest", this.handleChange, true]],
      [
        "doubleNumber",
        [
          "Many member your group",
          this.handleChange,
          "MIN",
          "minMember",
      ...
      [
        ...
        [
          ...
          "MAX",
          "maxDuration",
          this.state.dataTour.maxDuration,
          false
        ]
      ],
      [
      ...
      [
        ...
        [
          ...
          "MIN",
          "minPrice",
          this.state.dataTour.minPrice,
          false,
          "MAX",
          "maxPrice",
          this.state.dataTour.maxPrice,
          false
        ]
      ],
      [
        "number",
        ["Food", "food", this.handleChange, false, this.state.dataTour.food, 0]
      ],
      [
        "doubleRadio",
        [
      ...
      [
        "manyText",
        [
          "Message special detail of this tour",
          "highlight",
          this.handleChange,
          false,
          "20",
