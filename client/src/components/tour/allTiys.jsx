    ...
    return (
      <div className=" minWidth100  ">
        ...
        <div className=" minWidth100 clearBoth  headColumn">
          <div className="width30 textLeft paddingLeft10px sameLine ">
            NAME TOUR
          </div>
        ...
        {isLoaded &&
          tiys.map(t => (
            <div className="">
              <p key={t._id} className="sameLine width30">
                {t.name}
              </p>
              <p className="sameLine width20 textCenter">{t.dest}</p>
              <p className="sameLine width20 textCenter">
                {t.minPrice} - {t.maxPrice}
              </p>
              <p className="sameLine width15 textCenter">
                {t.minDuration} - {t.maxDuration}
              </p>
              <Link
                className="btn btn-primary sameLine"
                to={{
